...
public class TestAssignManager {
    ...
    static void init() throws RoleMismatchException, ProjectAlreadyExistsException, ClientDoesNotExistException {
        ...
        Project project=new Project("testAssign-1","test assign description", LocalDate.of(2026,9,12),LocalDate.of(2028,9,10));
    ...
    void testAssignNonManager(){
        assertThrowsExactly(ClassCastException.class,()->projectService.assignManager("testAssign-1","raman1"));
    }
    @Test
